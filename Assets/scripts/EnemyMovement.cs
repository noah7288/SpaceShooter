...
public class EnemyMovement : MonoBehaviour
{
    ...
    private IEnumerator Hide(Transform Target)
    {
        ...
        //                if (UnityEngine.AI.NavMesh.SamplePosition(Colliders[i].transform.position - (Target.position - hit.position).normalized * 2, out UnityEngine.AI.NavMeshHit hit2, 2f, Agent.areaMask))
        //                {
